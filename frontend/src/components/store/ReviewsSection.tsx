...
interface Review { id: string; rating: number; comment: string; sentiment: string | null; urgency: string | null; ai_status?: 'completed' | 'pending'; created_at: string; users?: { name: string } }
