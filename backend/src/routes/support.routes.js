...
const { createTicketSchema, updateTicketSchema, replyTicketSchema } = require('../validators/support.validators');
const {
  getTickets, getTicket, createTicket, updateTicket, escalateTicket, getSentimentReport, resolveTicket, replyToTicket,
